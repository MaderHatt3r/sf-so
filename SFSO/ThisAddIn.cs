...
namespace SFSO
{
    ...
    public partial class ThisAddIn
    {
        ...
        private void ThisAddIn_Startup(object sender, System.EventArgs e)
        {
            ...
            {
                //System.Windows.Forms.MessageBox.Show("A problem occured during startup of SFSO Add-In." +
                //    Environment.NewLine + Environment.NewLine + ex.Message + Environment.NewLine + Environment.NewLine + ex.StackTrace);
            }
        }
